...
const SvgBlock = ({color, category, variant}) => {
  const getPath = (variant) => {
    switch (variant) {
      ...
      case 2:
        return "M23 0C10.2975 0 0 10.2975 0 23C0 35.7025 10.2975 46 23 46H80V29.9282L68 36.8564V9.14355L80 16.0718V0H23Z";
      case 3:
        return "M23 0C10.2975 0 0 10.2975 0 23C0 35.7025 10.2975 46 23 46H80V34L66 24L80 13V0H23Z";
      case 4:
        return "M23 0C10.2975 0 0 10.2975 0 23C0 35.7025 10.2975 46 23 46H80V36L68.7417 29.5V16.5L80 10V0H23Z";
      case 5:
