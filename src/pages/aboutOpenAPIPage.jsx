    ...
    return (
        <div className={styles.container}>
            <div className={styles.headerContainer}>
                <p className={styles.header}>OPEN API 소개</p>
            ...
            <div className={styles.bodyContainer}>
                <div className={styles.contentContainer}>
                    ...
                    <p className={styles.content}>
                        AI 개발자 없이도, 사전 준비 없이도. PROMA는 간편한 API
                        키 발급으로 귀사의 AI 활용을 시작할 수 있도록 돕습니다.
                        시간을 절약하고, 효율은 높이고! 이제 비즈니스 혁신을
                        한층 더 가볍게 경험하세요!
                    </p>
                    ...
                    <p className={styles.content}>
                        직접 만든 프롬프트로 PROMA API 발급을 통해 손쉽게 AI를
                        사용할 수 있습니다. 챗봇을 만들기 위해서는 다양한
                        플로우와 설정, 그리고 복잡한 절차가 필요하지만
                        PROMA에서는 해당 절차를 훨씬 간소화한 절차를 제공합니다.
                        이는 AI 개발자 없이, 외주 없이 간편하게 AI를 활용할 수
                        있게합니다. 따라서 기업의 개발자 고용 비용은 낮추고 AI
                        활용도는 높이는 경험을 할 수 있습니다.
                    </p>
                    <div className={styles.contentSubTitle}>
                    ...
                    <p className={styles.content}>
                        ...
                        확인하고 관리할 수 있도록 해당 로그를 채팅방의 형태로
                        제공합니다. 사용자의 아이디를 이름으로 가지는 채팅방이
                        생성되며 그곳에서 실시간으로 사용자들의 사용 기록을
                        살펴볼 수 있습니다.
                    </p>
